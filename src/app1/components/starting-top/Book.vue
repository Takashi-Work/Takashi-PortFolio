                ...
                <div class="middle_title">
                   ...
                   <div class="used2">
                    ...
                    <div class="used3">　　
                      ...
                      <h5>JavaScriptの非同期通信(Ajax)を使い、SPAを意識したWEBアプリケーション製作をしました。</h5>　
                ...
                <div class="middle_title">
                   ...
                   <div class="used2">
                    ...
                    <div class="used3">　　
                      ...
                      <h5>改修によるデータベースへのテーブル・カラム変更</h5>　

                      <h5>御客様が指定した画面にする為、BootStrap使いレスポンシブ対応のレイアウト等の改修・追加を担当させて戴いてます</h5>　
